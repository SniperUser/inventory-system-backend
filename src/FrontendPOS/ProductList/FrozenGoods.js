...
const FrozenGoods = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/frozen/getFrozenGoods")
      .then((res) => res.json())
      .then((data) => {
        setItems(data);
        setLoading(false);
  ...
  if (loading) return <p className="p-3">Loading Frozen Goods...</p>;

  return (
    <div className="container mt-3">
      <h3 className="sale-product">Frozen Goods</h3>
