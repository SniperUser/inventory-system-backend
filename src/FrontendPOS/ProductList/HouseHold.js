...
const HouseholdItems = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/household/getHouseholdItems")
      .then((res) => res.json())
      .then((data) => {
        setItems(data);
        setLoading(false);
  ...
  if (loading) return <p className="p-3">Loading Household Items...</p>;

  return (
    <div className="container mt-3">
      <h3 className="sale-product">Household Items</h3>
