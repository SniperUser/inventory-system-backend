...
const InstantNoodles = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/instantnoodles/getInstantNoodles")
      .then((res) => res.json())
      .then((data) => {
        setItems(data);
        setLoading(false);
  ...
  if (loading) return <p className="p-3">Loading Instant Noodles...</p>;

  return (
    <div className="container mt-3">
      <h3 className="sale-product">Instant Noodles</h3>
