...
const PersonalCare = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/personalcare/getPersonalCare")
      .then((res) => res.json())
      .then((data) => {
        setItems(data);
        setLoading(false);
  ...
  if (loading) return <p className="p-3">Loading Personal Care...</p>;

  return (
    <div className="container mt-3">
      <h3 className="sale-product">Personal Care</h3>
      ...
      <div className="row">
        {filteredItems.length > 0 ? (
          ...
          <p>No Personal Care products found.</p>
        )}
      </div>
