...
const Laundry = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/laundry/getLaundry")
      .then((res) => res.json())
      .then((data) => {
        setItems(data);
        setLoading(false);
  ...
  if (loading) return <p className="p-3">Loading Laundry Products...</p>;

  return (
    <div className="container mt-3">
      <h3 className="sale-product">Laundry</h3>
