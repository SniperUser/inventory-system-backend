...
const Delivery = () => {
    ...
    const fetchDeliveries = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/deliveries/get"
        );
  ...
  if (loading) return <p className="text-center mt-5">Loading deliveries...</p>;
  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize: "12px", // 🔽 reduce global font size
      }}
    >
      {/* Header */}
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h5 className="m-0">📦 Deliveries</h5>
